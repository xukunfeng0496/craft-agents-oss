...
We take security seriously. If you discover a security vulnerability in Work Agents, please report it responsibly.
...
- The Work Agents desktop application
- The `@craft-agent/*` npm packages
- Official Work Agents repositories
