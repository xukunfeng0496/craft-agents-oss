...
# electron-builder outputs: Work-Agent-x86_64.AppImage or Work-Agent-aarch64.AppImage
...
# Rename to our standard naming convention: Work-Agent-x64.AppImage, Work-Agent-arm64.AppImage
