...
import type { StatusConfig } from '@work-agent/shared/statuses'
import { isEmoji } from '@work-agent/shared/utils/icon-constants'
import { resolveEntityColor, getDefaultStatusColor } from '@work-agent/shared/colors'
import type { EntityColor } from '@work-agent/shared/colors'
