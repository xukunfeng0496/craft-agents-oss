...
export interface AppShellContextType {
  ...
  labels?: import('@work-agent/shared/labels').LabelConfig[]
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@work-agent/core').ContentBadge[]) => void
