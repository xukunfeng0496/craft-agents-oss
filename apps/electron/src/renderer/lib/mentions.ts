...
import type { ContentBadge } from '@work-agent/core'
import type { MentionItemType } from '@/components/ui/mention-menu'
import type { LoadedSkill, LoadedSource } from '../../shared/types'
import { AGENTS_PLUGIN_NAME } from '@work-agent/shared/skills/types'
...
import { parseMentions, stripAllMentions, type ParsedMentions } from '@work-agent/shared/mentions'
