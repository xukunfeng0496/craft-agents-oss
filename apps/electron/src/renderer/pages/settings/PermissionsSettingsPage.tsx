 ...
 * Shows both default patterns (from ~/.workagent/permissions/default.json)
 * and custom workspace additions (from workspace permissions.json).
 *
 * Default patterns can be edited by the user in ~/.workagent/permissions/default.json.
...
/**
 * Build default permissions data from ~/.workagent/permissions/default.json.
                      ...
                      {defaultPermissionsData.length > 0 ? (
                        ...
                        <div className="p-8 text-center text-muted-foreground">
                          ...
                          <p className="text-xs mt-1 text-foreground/40">
                            {labels.defaultPermissionsEmptyDescriptionPrefix} <code className="bg-foreground/5 px-1 rounded">~/.workagent/permissions/default.json</code>
                          </p>
                        </div>
                      )}
                    </SettingsCard>
