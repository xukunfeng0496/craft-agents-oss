...
export interface FileAttachment {
  ...
  size: number
  storedPath?: string  // Session attachment storage path used for prompt references
  markdownPath?: string  // Converted markdown sidecar for Office files
...
export interface ElectronAPI {
  ...
  // Get file path from File object (for drag-drop scenarios)
  ...
  // Skills
  getSkills(workspaceId: string, projectRoot?: string): Promise<LoadedSkill[]>
