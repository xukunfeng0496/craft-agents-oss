/**
 * Generates index.html showcasing all @work-agent/mermaid rendering capabilities.
 *
    ...
    <div class="brand-badge-wrapper">
      ...
      <div class="brand-dropdown shadow-modal-small" id="brand-dropdown">
        <a href="https://agents.craft.do" class="brand-dropdown-item" target="_blank" rel="noopener">
          <svg width="18" height="18" class="brand-dropdown-logo" style="margin-left: -4px;" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><rect x="2.5" y="3" width="4" height="18" rx="1" fill="#1E5C35"/><rect x="7.5" y="8" width="4" height="13" rx="1" fill="#1E5C35"/><rect x="12.5" y="8" width="4" height="13" rx="1" fill="#1E5C35"/><rect x="17.5" y="3" width="4" height="18" rx="1" fill="#1E5C35"/><rect x="2.5" y="17" width="19" height="4" rx="1" fill="#1E5C35"/></svg>
          <span style="margin-left: -2px;">Work Agents<span class="tagline">Simply mind-blowing</span></span>
        </a>
