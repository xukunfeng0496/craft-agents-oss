 ...
 * The WorkAgent facade delegates to these backends, enabling provider switching while
 ...
 * - AsyncGenerator for streaming: Consistent with existing WorkAgent API
 */
 ...
 * 2. Enable the facade pattern in WorkAgent
