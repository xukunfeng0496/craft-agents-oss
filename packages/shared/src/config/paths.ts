 ...
 * script sets CRAFT_CONFIG_DIR to ~/.workagent-1, allowing multiple instances to run
...
export const CONFIG_DIR = process.env.CRAFT_CONFIG_DIR || join(homedir(), '.workagent');
