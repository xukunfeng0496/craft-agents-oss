...
import type { StoredAttachment, StoredMessage } from '@work-agent/core/types';
...
import type { Workspace, AuthType } from '@work-agent/core/types';
...
export type { StoredAttachment, StoredMessage } from '@work-agent/core/types';
