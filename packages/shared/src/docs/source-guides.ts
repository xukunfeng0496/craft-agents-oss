 ...
 * Guides are now served exclusively via the work-agents-docs MCP server.
 *
 ...
 * Use the work-agents-docs MCP server to search for setup guides.
 *
 * Example: mcp__work-agents-docs__SearchWorkAgents({ query: "github source setup guide" })
 */
