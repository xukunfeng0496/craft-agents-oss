...
import type { StoredAttachment, MessageRole, ToolStatus, AuthRequestType, AuthStatus, CredentialInputMode, StoredMessage } from '@work-agent/core/types';
 ...
 * Re-exported from @work-agent/core for convenience
 */
export type { StoredMessage } from '@work-agent/core/types';
