...
describe('classifyExternalUrl — internal deep links', () => {
  it('classifies workagents:// as internal-deeplink', () => {
    expect(classifyExternalUrl('workagents://settings').kind).toBe('internal-deeplink')
  })
...
describe('formatBlockedUrlError', () => {
  ...
  it('returns an empty string for non-dangerous classifications', () => {
    ...
    expect(formatBlockedUrlError(classifyExternalUrl('workagents://settings'))).toBe('')
  })
})
...
describe('isSafeExternalUrl', () => {
  ...
  it('returns false for internal deep links', () => {
    expect(isSafeExternalUrl('workagents://settings')).toBe(false)
  })
