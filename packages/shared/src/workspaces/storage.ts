 ...
 * Default location: ~/.workagent/workspaces/
 */
...
/**
 * Get the default workspaces directory (~/.workagent/workspaces/)
 */
 ...
 * @param baseDir - Parent directory where workspace folders live (e.g., ~/.workagent/workspaces/)
 ...
 * Returns paths to valid workspaces found in ~/.workagent/workspaces/
 */
